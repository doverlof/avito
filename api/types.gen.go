...
type UserStatistics struct {
	...
	// MergedAuthoredPrs Количество смерженных PR (как автор)
	MergedAuthoredPrs int `json:"merged_authored_prs"`

	// MergedReviewAssignments Количество назначений на смерженные PR (как ревьюер)
	MergedReviewAssignments int `json:"merged_review_assignments"`

	// OpenAuthoredPrs Количество открытых PR (как автор)
	OpenAuthoredPrs int `json:"open_authored_prs"`

	// OpenReviewAssignments Количество назначений на открытые PR (как ревьюер)
	OpenReviewAssignments int    `json:"open_review_assignments"`
	TeamName              string `json:"team_name"`

	// TotalAuthoredPrs Общее количество созданных PR
	TotalAuthoredPrs int `json:"total_authored_prs"`

	// TotalReviewAssignments Общее количество назначений на ревью
